...
def get_gt_correct_format(df, fpath):
    ...
    with open("clean_homographs.txt", "w") as f:
        for homograph in homographs:
            f.write(homograph + "\n")


# get_gt_correct_format("WHD_full_clean.pkl", "gt_prons.txt")
...
def get_in_lex_sentences(out_lex_idxs, src_file):
    ...
    assert len(in_lex_train_ids) == 9241
    assert len(clean_eval_ids) == 1603
